...
public:
	ShowAtVenue(const Show& show,  Venue& venue, const char* date);
...
//	void setShow(const Show* show);
	...
	bool operator==(const ShowAtVenue& other) const
		{ return ((getShow() == other.getShow()) && (m_venue == other.m_venue) && strcmp(getDate(), other.getDate()) == 0); }
